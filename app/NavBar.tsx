...
const NavBar = () => {
  return (
    <div className="shadow-md w-screen fixed h-24 md:h-28  top-0 bg-white">
      <div className="m-auto max-w-[1280px] flex flex-row space-between p-4 md:p-6 lg:p-6 xl:p-6 2xl:p-6 items-center">
        <div className="border-l-4 rounded-lg pl-4 border-[#393939] w-full flex flex-col items-left justify-center">
          <Link href="/">
            ...
            <h1 className="text-[#393939] font-serif font-bold text-2xl sm:text-3xl md:text-4xl xl:text-4xl 2xl:text-4xl ">
              J.CONCANNON
            </h1>
          </Link>
        </div>
